    ...
    <main className="backG">
              ...
              <div>
                ...
                <div className="btnSanit">
                  <Link to={"/informacionSanitaria"} className="text-white btn">
                    <p className="h6">Información Sanitaria</p>
                  </Link>
                </div>
              </div>
            </Col>
              ...
              <div>
                ...
                <div className="btnProg">
                  <Link to={"/programaDeSalud"} className="text-white btn">
                    <p className="h6 mt-1">Programa de Salud</p>
                  </Link>
                </div>
              </div>
            </Col>
              ...
              <div>
                ...
                <div className="btnCent">
                  <Link to={"/centrosSanitarios"} className="text-white btn">
                    <p className="h6 mt-1">Centros Sanitarios</p>
                  </Link>
                </div>
              </div>
            </Col>
      ...
      <section className="informativo">
        <div className="container">
          ...
          <Row className="d-flex flex-wrap">
            <Col sm={12} lg={6} className="d-flex justify-content-lg-end justify-content-md-center justify-content-sm-center">
              <Card className="w-75 my-3 cardInfo">
                <Link to={"/"}>
            ...
            <Col sm={12} lg={6} className="d-flex justify-content-lg-start justify-content-md-center justify-content-sm-center">
              <Card className="w-75 my-3 cardInfo">
                <Link to={"/"}>
          ...
          <Row className="d-flex flex-wrap">
            <Col sm={12} md={6} lg={3} className="d-flex justify-content-center">
              <Card className="m-3 cardServ w-100">
                <Link to={'/'}>
                    ...
                    <Card.Body>
                        <Card.Text className="h6">Indicadores de Atención</Card.Text>
                    </Card.Body>
                </Link>
              </Card>
            </Col>
            <Col sm={12} md={6} lg={3} className="d-flex justify-content-center">
              <Card className="m-3 cardServ w-100">
                ...
                <Card.Body >
                        <Card.Text>Mapa de Efectores con Nutricionistas</Card.Text>
                    </Card.Body>
                </Link>
              </Card>
            </Col>
            <Col sm={12} md={6} lg={3} className="d-flex justify-content-center">
              <Card className="m-3 cardServ w-100">
                ...
                <Card.Body>
                        <Card.Text>Medicina Molecular y Celular Aplicada</Card.Text>
                    </Card.Body>
                </Link>
              </Card>
            </Col>
          ...
          <Row className="d-flex flex-wrap">
            <Col sm={12} md={6} lg={3} className="d-flex justify-content-center">
              <Card className="m-3 cardServ w-100">
                ...
                <Card.Body>
                        <Card.Text>Plan Dengue</Card.Text>
                    </Card.Body>
                </Link>
              </Card>
            </Col>
            <Col sm={12} md={6} lg={3} className="d-flex justify-content-center">
              <Card className="m-3 cardServ w-100">
                ...
                <Card.Body>
                        <Card.Text>Boleta Digital</Card.Text>
                    </Card.Body>
                </Link>
              </Card>
            </Col>
            <Col sm={12} md={6} lg={3} className="d-flex justify-content-center">
              <Card className="m-3 cardServ w-100">
                ...
                <Card.Body>
                        <Card.Text>Canal de Capacitación RRHH</Card.Text>
                    </Card.Body>
                </Link>
              </Card>
            </Col>
            <Col sm={12} md={6} lg={3} className="d-flex justify-content-center">
              <Card className="m-3 cardServ w-100">
                ...
                <Card.Body>
                        <Card.Text>Sala de Situación</Card.Text>
                    </Card.Body>
                </Link>
              </Card>
            </Col>
          ...
          <Row className="d-flex flex-wrap">
            <Col sm={12} md={6} lg={3} className="d-flex justify-content-center">
              <Card className="m-3 cardServ w-100">
                ...
                <Card.Body>
                        <Card.Text>Registro Provincial de Electrodependientes</Card.Text>
                    </Card.Body>
                </Link>
              </Card>
            </Col>
            <Col sm={12} md={6} lg={3} className="d-flex justify-content-center">
              <Card className="m-3 cardServ w-100">
                ...
                <Card.Body>
                        <Card.Text>Residencias Médicas</Card.Text>
                    </Card.Body>
                </Link>
              </Card>
            </Col>
            <Col sm={12} md={6} lg={3} className="d-flex justify-content-center">
              <Card className="m-3 cardServ w-100">
                ...
                <Card.Body>
                        <Card.Text>Estratégias de Salud Pública</Card.Text>
                    </Card.Body>
                </Link>
              </Card>
            </Col>
            <Col sm={12} md={6} lg={3} className="d-flex justify-content-center">
              <Card className="m-3 cardServ w-100">
                ...
                <Card.Body>
                        <Card.Text>Rescursos gráficos y campañas</Card.Text>
                    </Card.Body>
                </Link>
              </Card>
            </Col>
