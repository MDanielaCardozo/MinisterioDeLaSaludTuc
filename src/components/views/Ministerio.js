    ...
    <div className="bgColor">
        ...
        <Accordion defaultActiveKey="0" flush>
          ...
          <Accordion.Item eventKey="2" className="acordion">
            ...
            <Accordion.Body>
              ...
              <br /> . Orientar a la población tucumana y a la sociedad en
              general hacia estilos de vida saludables, y al control de los
              determinantes que afecten la Salud Pública.
              <br /> . Perfeccionar los procesos y programas exitosos, en
              función de la mejora de los indicadores de salud y de bienestar de
              la población.
              <br /> . Ejercer y fortalecer el rol de rectoría del Ministerio de
              Salud Pública en el ámbito sanitario de la provincia.
              <br /> . Interpretar y adecuar las políticas y programas
              sanitarios nacionales para su aplicación en la provincia.
              <br /> . Participar en el fortalecimiento de las capacidades
              resolutivas regionales, en especial del NOA, para la más eficiente
              utilización de los recursos.
              <br /> . Mantener y profundizar las capacidades del sistema
              sanitario de monitoreo y análisis de la situación de salud para la
              toma de decisiones oportunas en sus distintos niveles.
              <br /> . Afianzar la red de vigilancia de riesgos y daños a la
              Salud Pública para su efectivo control.
              <br /> . Avanzar en el desarrollo de las condiciones culturales,
              regulatorias, legales y de participación para que la promoción de
              la salud sea efectiva.
              <br /> . Lograr la participación ciudadana en los distintos
              niveles de decisión.
              <br /> . Profundizar las capacidades de planificación en Salud
              Pública.
              <br /> . Fortalecer la capacidad regulatoria y de fiscalización.
              <br /> . Mantener el análisis permanente del acceso con equidad a
              los distintos servicios de salud en el ámbito provincial.
              <br /> . Avanzar en la capacidad de planificación de los recursos
              humanos y de la programación de su desarrollo técnico y
              científico.
              <br /> . Hacer de la calidad de los servicios el eje de la
              humanización de la salud, para que éstos sean dignos de los
              usuarios y motivo de orgullo para los trabajadores.
              <br /> . Continuar incentivando las investigaciones en los asuntos
              relacionados con las prioridades sanitarias de la región.
              <br /> . Profundizar el desarrollo institucional del sistema y
      ...
      <section className="container">
        ...
        <div className="cardTer mt-3 text-light text-center p-2">
          ...
          <p>
            ° Dra. Cristina Majul ° Dra. Eliana Molina ° Dra. Lucía Mabel Cebe
          </p>
        </div>
        <div className="cardTer mt-3 text-light text-center p-2">
